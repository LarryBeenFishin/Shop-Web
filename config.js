...
(function loadSharedAdminAssets(){
  ...
  if(!document.querySelector('script[data-shop-shared-header]')){const script=document.createElement('script');script.src='/admin/shared-header.js?v=9';script.dataset.shopSharedHeader='true';document.head.appendChild(script);}
