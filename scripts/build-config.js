...
(function loadSharedAdminAssets(){
  ...
  css('data-shop-admin-skin','/admin/admin-redesign.css?v=5');
  css('data-shop-status-skin','/admin/status-hidden.css?v=1');
  js('data-shop-shared-header','/admin/shared-header.js?v=8');
  js('data-shop-vehicle-data','/assets/vehicle-data.js?v=1');
  js('data-shop-appt-modal','/admin/appointment-modal-redesign.js?v=3');
